...
beforeAll(async () => {
  try {
    db = knexLib({ client: "mysql2", connection: { host: "localhost", port: 3306, user: "empcloud", password: process.env.DB_PASSWORD || "", database: "emp_rewards" } });
...
describe.skipIf(!dbAvailable)("Challenge service coverage", () => {
...
describe.skipIf(!dbAvailable)("Nomination service coverage", () => {
...
describe.skipIf(!dbAvailable)("Redemption service coverage", () => {
...
describe.skipIf(!dbAvailable)("Budget service coverage", () => {
...
describe.skipIf(!dbAvailable)("Celebration service coverage", () => {
...
describe.skipIf(!dbAvailable)("Leaderboard service coverage", () => {
...
describe.skipIf(!dbAvailable)("Milestone service coverage", () => {
...
describe.skipIf(!dbAvailable)("Settings service coverage", () => {
...
describe.skipIf(!dbAvailable)("Slack/Teams formatting", () => {
